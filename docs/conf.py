...
project = 'Politifact-Py'
copyright = '2018, Jonathon Belotti'
...
htmlhelp_basename = 'Politifact-Pydoc'
...
latex_documents = [
    (master_doc, 'Politifact-Py.tex', 'Politifact-Py Documentation',
     'Jonathon Belotti', 'manual'),
]
...
man_pages = [
    (master_doc, 'politifact-py', 'Politifact-Py Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Politifact-Py', 'Politifact-Py Documentation',
     author, 'Politifact-Py', 'One line description of project.',
     'Miscellaneous'),
]
